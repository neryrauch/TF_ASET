...
# Definir el orden de las franjas
Orden_Franja <- c("Menores", "Jov.15-18", "Jov.19-24", "Jov.25-29", "Adultos", "Adultos Mayores")

# Asegurarse de que 'Franja Etaria' sea un factor con el orden correcto
...
kable(Precariedad_Franja_Etaria_Tabla, 
      caption = "Cantidad de trabajadores ocupados en base a la situación de precariedad y la franja etaria", 
      align = 'c') %>% 
  kable_styling(full_width = FALSE, position = "center",
                bootstrap_options = c("striped", "hover", "responsive")) %>%
  column_spec(1, bold = TRUE, color = "black", background = "white", extra_css = "padding: 10px;text-align: left;") %>%
